...
**野行 Y 计划，是我发起的一个项目**：做自驾行程、召集一起玩的小伙伴、然后开着车出发，基本都有一定程度的越野成分。我们还有一个专门的路线网站，上面每一条路线，都是我各种检索、翻遍各个平台、各种比对和分析，最后整理成一份**能直接照着出发**的行程。

## 这些路，都是真的开过的

从国内的**青甘大环线**、**内蒙古西部大环线**、**川西大环线**、**南疆大环线**、**藏东大环线**，到境外的**泰南大环线**、**埃及大环线**、**不列颠大环线**、**斯里兰卡大环线**、**贝加尔湖大环线**…等等这些，都是自己设计、规划，招募到一起的小伙伴，然后**开着车、一公里一公里走完的**。
